    ...
    <nav class="navbar navbar-expand-lg navbar-light border-bottom border-dark" style="background-color: #e3f2fd;">
        <div class="container-fluid">
            ...
            <div class="navbar-nav position-absolute top-50 start-50 translate-middle">
                <a href="../index_guardian/index_guardianHome.html" class="nav-link active text-decoration-none"> *Home*
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav position-absolute top-50 end-0 translate-middle-y">
                    ...
                    <li class="nav-item">
                        <a href="../index_guardian/index_guardianPerfil.html" class="nav-link text-decoration-none"> *Mi
                            Perfil*</a>
                    </li>
                </ul>
            </div>
